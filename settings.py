...
MEDIA_ROOT = '/home/helios-server/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://psych-it.cdc.informatik.tu-darmstadt.de/media/'
...
URL_HOST = get_from_env("URL_HOST", "http://psych-it.cdc.informatik.tu-darmstadt.de:80").rstrip("/")
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "Welcome to Helios [last update: 31.05.2016 21:42]")
